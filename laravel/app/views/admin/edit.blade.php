...
<div class="container">
    <div class="row">
        <ul class="nav nav-tabs" role="tablist">
            <li>{{HTML::LinkRoute('admin.account.show',trans('frontend.link.user.show'),array(Auth::user()->id))}}</li>            
        </ul>
    </div>
    <div class="row">
        <div class="col-sm-6 col-sm-push-3">
            ...
            {{ Form::model($user,  array('route' => array('admin.account.update',$user->id), 'method' => 'PUT')) }}            
